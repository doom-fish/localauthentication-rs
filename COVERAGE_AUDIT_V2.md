# localauthentication-rs coverage audit v2 (vs MacOSX26.2.sdk)
...
| `LAEnvironmentMechanismCompanion.stateHash` | property | `LAEnvironmentMechanismCompanion.h` | `LAEnvironmentMechanismCompanion::stateHash` |
